...
import { Users, UserCheck, UserX, TrendingUp, Target, Award, Briefcase } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      const conversionData = await dashboardService.getConversionData(null, true);
