            ...
            //<https: //github.com/PHPMailer/PHPMailer/issues/2298>), and
                ...
                */
                ...
                for ($i = 0; $i < $length; ++$i) { $c=$string[$i]; //All other characters have a special meaning in at
                    ...
                    https://www.rfc-editor.org/rfc/rfc3986#section-3.1 return !preg_match('#^[a-z][a-z\d+.-]*://#i',
                    ...
                    https://www.php.net/manual/en/book.mail.php * * @param string $header The message headers * @param
                        ...
                        */
                        ...
                        !preg_match('/^(?P<lang>[a-z]{2})(?P<script>
                            ...
                            function createBody() {
                                ...
                                elseif(static::ENCODING_8BIT === $bodyEncoding && !$this - > has8bitChars($this - >
                                    Body)) {
                             ...
                             */
                            public
                            function clearCustomHeader($name, $value = null) {
                             ...
                             */
                            public
                            function replaceCustomHeader($name, $value = null) {
                                if (null === $value && strpos($name, ':') !== false) {
                                    //Value passed in as name:value
                                    list($name, $value) = explode(':', $name, 2);
                                }
                             ...
                             */
                            protected
                            function addressHasUnicodeLocalPart($address) {
                             ...
                             */
                            protected
                            function anyAddressHasUnicodeLocalPart($addresses) {
